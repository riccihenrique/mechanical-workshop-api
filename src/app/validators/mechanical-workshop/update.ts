...
class makeUpdateMechanicalWorkshopValidator implements IValidatorBase {
...
export const UpdateMechanicalWorkshopValidator = new makeUpdateMechanicalWorkshopValidator();